...
let CardsComponent = class CardsComponent {
    constructor(formBuilder, router, paymentService) {
...
let ValidationService = class ValidationService {
    ...
    static dateValidityCheck(control) {
    ...
    // tslint:disable-next-line:member-ordering
    static alternateEmailValidator(control) {
        // RFC 2822 compliant regex
        if (control.value === '') {
            return null;
        }
    ...
    // tslint:disable-next-line:member-ordering
    static NumberPureValidator(control) {
        // Numbers
        if (!control.value) {
            return null;
        }
    ...
    // tslint:disable-next-line:member-ordering
    static capacityValidator(control) {
    ...
    // tslint:disable-next-line:member-ordering
    static patternValidator(control, pattern) {
   ...
   */
     ...
     */
    // tslint:disable-next-line:member-ordering
    static HybridEmailPhone(siblingName, valueField, countryCodeField) {
        return (control) => {
            if (control.parent) {
                const fc = control.parent.controls[siblingName];
                const valueControl = control.parent.controls[valueField];
                if (!control.value)
                    return null;
                if (control.value.match(/^[0-9 ]*$/)) {
                    fc.setValue(true);
...
let PaymentService = class PaymentService {
    ...
    setCardId(id) {
        _transaction_json__WEBPACK_IMPORTED_MODULE_3__.map((item) => {
            if (item.id == id) {
...
module.exports = JSON.parse("[{\"id\":\"P0001\",\"name\":\"Punreet Kaur\",\"card_number\":\"XXXXXXXXXXX345\",\"cvc\":499,\"type\":\"./assets/images/visa.jpeg\",\"valid\":\"03/22\",\"validity\":true,\"total\":450,\"transactions\":[{\"id\":\"tran_123\",\"product_name\":\"apple i phone\",\"price\":433,\"date\":\"14/04/2019\",\"description\":\"new product with 6gb ram\"},{\"id\":\"tran_456\",\"product_name\":\"samsung note 10\",\"price\":901,\"date\":\"14/04/2019\",\"description\":\"new product\"}]},{\"id\":\"P0002\",\"name\":\"amrit singh\",\"card_number\":\"XXXXXXXXXXX678\",\"cvc\":499,\"type\":\"/assets/images/mastercard.jpeg\",\"valid\":\"11/12\",\"validity\":false,\"total\":950,\"transactions\":[{\"id\":\"tran_888\",\"product_name\":\"Phone\",\"price\":433,\"date\":\"14/04/2019\",\"description\":\"new product with 6gb ram\"}]}]");
